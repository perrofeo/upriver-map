...
const DICC = {
  es: {
    ...
    'ficha.abrir': 'Abrir la ficha',
    'ficha.plegar': 'Abrir o plegar la ficha',
  ...
  en: {
    ...
    'ficha.abrir': 'Open the card',
    'ficha.plegar': 'Open or fold the card',
  ...
  eu: {
    ...
    'ficha.abrir': 'Ireki fitxa',
    'ficha.plegar': 'Ireki edo tolestu fitxa',
